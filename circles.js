/* circles.js
 * For creating donus charts
 * Slightly modified for Nexus to add borders around the circles:
 *    add "border" in the options for border width
 *    add an extra color in the color array for border color
 *  See Source material folder for original
 */
...
(function() {
  ...
  Circles = window.Circles = function(options) {
	...
	this._borderWidth    = options.border  || 0;
    this._colors         = options.colors || ['#EEE', '#F00', '#999'];
    this._svg            = null;
  ...
  Circles.prototype = {
    ...
    _generateSvg: function() {
      ...
      this._generatePath(100, false, this._colors[2], 0)._generatePath(100, false, this._colors[0], -this._borderWidth)._generatePath(1, true, this._colors[1], -this._borderWidth);
    ...
    _generatePath: function(percentage, open, color, strokeWidthMod) {
      var path = document.createElementNS('http://www.w3.org/2000/svg', 'path');
      path.setAttribute('fill', 'transparent');
      path.setAttribute('stroke', color);
      path.setAttribute('stroke-width', this._strokeWidth + strokeWidthMod);
    ...
    updateColors: function(colors) {
      ...
      paths[1].setAttribute('stroke', colors[0]);
      paths[2].setAttribute('stroke', colors[1]);
